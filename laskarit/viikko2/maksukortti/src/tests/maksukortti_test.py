...
class TestMaksukortti(unittest.TestCase):
    ...
    def test_syo_edullisesti_ei_vie_saldoa_negatiiviseksi(self):
        kortti = Maksukortti(200)  # ei käytä setupin korttia
    ...
    def test_kortilla_voi_ostaa_edullisen_lounaan_kun_rahaa_juuri_sen_verran(self):
        kortti = Maksukortti(250)
        kortti.syo_edullisesti()
        self.assertEqual(kortti.saldo_euroina(), 0.0)

    def test_kortilla_voi_ostaa_maukkaan_lounaan_kun_rahaa_juuri_sen_verran(self):
