...
class TestService(unittest.TestCase):
    ...
    def test_calculate_year_figures(self):
        table_all_months_planned, table_all_months_receivedspent = service.open_data_from_file("yes")
        ...
        self.assertEqual(count_months_filled_in, 12)
        self.assertEqual(sum_total_income, 36078)
        self.assertEqual(sum_total_rent, 9678)
        self.assertEqual(sum_total_bills, 1278)
        self.assertEqual(sum_total_spending, 6078)
        self.assertEqual(sum_total_debt_service, 4878)
        self.assertEqual(sum_total_saving, 12078)
...
class TestEntryFields(unittest.TestCase):
    ...
    def test_planned_income_field_accepts_int_but_not_text_and_float(self):
        ...
        self.assertEqual(self.UI._save_month_planned_figures(testing="yes"), None)
        self.assertEqual(self.UI._chosen_month_planned_income.get(), '3000')
        self.UI._chosen_month_planned_income.delete(0, tk.END)
        self.UI._chosen_month_planned_income.insert(0, 'word')
        self.assertEqual(self.UI._save_month_planned_figures(testing="yes"), 'Incorrect value')
        self.UI._chosen_month_planned_income.delete(0, tk.END)
    ...
    def test_receivedspent_income_field_accepts_int_but_not_text_and_float(self):
        ...
        self.assertEqual(self.UI._save_month_receivedspent_figures(testing="yes"), None)
        ...
        self.assertEqual(self.UI._save_month_receivedspent_figures(testing="yes"), 'Incorrect value')
        self.UI._chosen_month_receivedspent_income.delete(0, tk.END)
